...
class _PostItemState extends State<PostItem> {
  ...
  void showSummarySheet(BuildContext context,
      {required String postContent, String? imageUrl}) {
    print("Opening summary sheet for post content: $postContent");
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    print("Summarize button pressed for post: ${widget.docId}");
                    showSummarySheet(
                      context,
                      postContent: widget.postData['content'],
